    ...
    <HomeContainer>
      <Navbar>
        <NavContent>
          ...
          <NavButtons>
            <NavButton to="/login" className="secondary">Sign In</NavButton>
            <NavButton to="/register" className="primary">Get Started</NavButton>
          </NavButtons>
        </NavContent>
      </Navbar>
        ...
        <HeroContent>
          ...
          <StatsSection>
            ...
            <StatItem>
              ...
              <div className="label">Notes Shared</div>
            </StatItem>
            <StatItem>
